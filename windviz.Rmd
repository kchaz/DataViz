...
**Version 2**: This plots the circular mean and the 5% and 95% quantile of the posterior circular means, 5 at a time. It's a bit funky to look at but it does give a better picture because it show that the uncertainty in the wind direction is often quite large.
